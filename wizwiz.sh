...
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/kngg/settings/messagewizwiz.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/kngg/settings/rewardReport.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/kngg/settings/warnusers.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/kngg/settings/gift2all.php >/dev/null 2>&1") | sort - | uniq - | crontab -
...
wait
    ...
    if [[ $(mysql -u root -p$ROOT_PASSWORD -e "SHOW DATABASES LIKE 'wizwiz'") ]]; then
        ...
        file_path="/var/www/html/kngg/baseInfo.php"
        ...
        # print file
        echo -e "<?php" >> /var/www/html/kngg/baseInfo.php
        echo -e "error_reporting(0);" >> /var/www/html/kngg/baseInfo.php
        echo -e "${ASAS}botToken = '${YOUR_BOT_TOKEN}';" >> /var/www/html/kngg/baseInfo.php
        echo -e "${ASAS}dbUserName = '${dbuser}';" >> /var/www/html/kngg/baseInfo.php
        echo -e "${ASAS}dbPassword = '${dbpass}';" >> /var/www/html/kngg/baseInfo.php
        echo -e "${ASAS}dbName = '${dbname}';" >> /var/www/html/kngg/baseInfo.php
        echo -e "${ASAS}botUrl = 'https://${YOUR_DOMAIN}/kngg/';" >> /var/www/html/kngg/baseInfo.php
        echo -e "${ASAS}admin = ${YOUR_CHAT_ID};" >> /var/www/html/kngg/baseInfo.php
        echo -e "?>" >> /var/www/html/kngg/baseInfo.php

        sleep 1

        curl -F "url=https://${YOUR_DOMAIN}/kngg/bot.php" "https://api.telegram.org/bot${YOUR_BOT_TOKEN}/setWebhook"
        ...
        url="https://${YOUR_DOMAIN}/kngg/createDB.php"
        curl $url
	    ...
	    sudo rm /var/www/html/kngg/createDB.php
