    ...
    if($orders->num_rows>0){
        while ($order = $orders->fetch_assoc()){
            ...
            if($expiryTime != null && $total != null){
                ...
                if($send != ""){  
                    $msg = "💡 کاربر گرامی، 
        از سرویس اشتراک $remark تنها (۱ $send) باقی مانده است. قبل از حذف سرویس نسبت به تمدید آن اقدام کنید.";
        ...
        while ($order = $orders->fetch_assoc()){
            ...
            if($time > $notif) {
                ...
                if($send){  
                    ...
                    $msg = "💡 کاربر گرامی،
    اشتراک سرویس $remark منقضی شد و از لیست سفارش ها حذف گردید. لطفا سرویس جدید خریداری کنید.";
                    sendMessage( $msg, null, null, $from_id);
